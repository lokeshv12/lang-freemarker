...
import { syntaxHighlighting, HighlightStyle, LRLanguage, bracketMatchingHandle, syntaxTree, LanguageSupport } from '@codemirror/language';
...
const parser = LRParser.deserialize({
  ...
  nodeNames: "⚠ Comment Template Variable OpenTag StartTag TagName AttributeName EndTag Identifier ChainedIdentifier ArrayExpression Number String VariableName BooleanLiteral CloseTag StartCloseTag OpenBrace CloseBrace PlainText",
  maxTerm: 43,
  nodeProps: [
  ...
  tokenizers: [1, 2, 3, 4, new LocalTokenGroup("p~RQYZX}!O^~^Oo~~aP}!Od~gP!`!aj~oOp~~", 31, 30)],
...
const syntax_colors = syntaxHighlighting(HighlightStyle.define([
    { tag: tags.attributeName, color: "red" },
    { tag: tags.keyword, color: "#ffffff" },
]));
const FREEMARKERLanguage = LRLanguage.define({
    parser: parser.configure({
        props: [
            ...
            styleTags({
                ...
                "OpenTag CloseTag EndTag": tags.angleBracket,
...
export { FREEMARKER, FREEMARKERCompletion, FREEMARKERLanguage, autoCloseTags, syntax_colors };
